...
class UserCreateSerializer(DjoserUserCreateSerializer):
    ...
    verification_code = serializers.IntegerField(write_only=True, required=False, allow_null=True)
    profile_id = serializers.IntegerField(write_only=True, required=False, allow_null=True)

    class Meta(DjoserUserCreateSerializer.Meta):
        fields = DjoserUserCreateSerializer.Meta.fields + ('token', 'id', 'user', 'verification_code', 'profile_id')
...
class ProfileSerializerBase(serializers.ModelSerializer):
    ...
    verification_code = serializers.SerializerMethodField(read_only=True, source='get_verification_code')
    ...
    def get_verification_code(self, object):
        return object.verification_code if len(object.related_non_independent_profiles()) else None
